  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Bhargav excels in
      ...
      <br />
      <span>
        Bhargav K is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Bhargav is a big fan of cricket and
        ...
        significantly shaped Bhargav’s journey. Ankush is not only a great
        competitor but also a steadfast friend, constantly motivating Bhargav to
